...
public abstract class GameObj {
   ...
   public BufferedImage BufferedImageLoader(String string) 
   {
	   try
	    {
	        BufferedImage buffimg = ImageIO.read(this.getClass().getResource(string));
	        return buffimg;
	    } catch (IOException e)
	    {
    ...
    public boolean yIntersects(GameObj that) {
    	return (
                this.py + this.height >= that.py
                && that.py + that.height >= this.py); 
    }
    ...
    //this is a method for how the subclassed objects will attack the player 
